...
MODACS 是统一的工业软件平台品牌，旗下产品按 ISA-95 层级分为五个产品：

| 产品 | 定位 | 对标 | ISA-95 |
| :--- | :--- | :--- | :--- |
| **MODACS Sense** | 感知/监视/交互（SCADA/HMI/DAQ） | WinCC、组态王、LabVIEW | Level 2 |
...
> MES 首个落地应用的详细开发方案见 [MES-Development-Plan](./MES-Development-Plan.md)。
...
| **MODACS Sense** | 感知层产品（SCADA/HMI/DAQ） |
...
| [MES-Development-Plan](./MES-Development-Plan.md) | MES 开发方案：技术选型、渐进式路线图 |
| 嵌入式学习路线（外部笔记） | 独立开发者嵌入式进阶路径（位于 `人生规划/`） |
